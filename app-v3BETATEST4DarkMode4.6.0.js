...
document.write('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/unclelondeh/betatest@betablack/nexmoe_v2.minbeta4.0.css">');
...
if (UI.dark_mode) {
  document.write('<style>{box-sizing: border-box}body{color:rgba(255,255,255, .87);background-color:#202125}.mdui-theme-primary-${UI.dark_mode} .mdui-color-theme{background-color:#333232!important}</style>');
}
